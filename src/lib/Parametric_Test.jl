...
P:         IntervalBox{N,Float64} - Bounds for independent variables
PIflag:    Bool - Input exclusion flag.
incLow:    Array{Bool} - Array that is false if potential partial inclusion
--------------------------------------------------------------------------------
Returns:
Returns tuple (k,PIflag):
k:        Dimension at which partial inclusion potential exists
...
inclusionLow:     Array{Bool}: Array of boolean for inclusion test
inclusionHigh:    Array{Bool}:  Array of boolean for inclusion test
--------------------------------------------------------------------------------
Returns:
